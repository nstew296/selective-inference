...
def test_lasso(s=5, n=200, p=20, Langevin_steps=10000, burning=2000,
    ...
    init_state[subgrad_slice] = (-loss.gradient(data,initial_soln)[inactive] + random_Z[inactive] * randomization_scale) / lam
    ...
    def full_gradient(state, Sigma_full_inv=Sigma_full_inv,
