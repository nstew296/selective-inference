...
plt.legend()
plt.ylabel('Ratio of Interval Lengths for Common Parameters', fontsize=20)
plt.yticks(fontsize=18)

ax1.set_title("Ratio of Confidence Interval Lengths", y=1.01 ,fontsize=20)
ax1.legend(loc='lower left', bbox_to_anchor=(0.3225, -0.15), fontsize=20)
ax1.set_xticklabels([])
ax1.set_xticks([])
...
plt.yticks(fontsize=18)
ax1.set_title("Distribution of Interval Lengths", y=1.01 ,fontsize=20)
ax1.set_xticklabels([])
ax1.set_xticks([])
common_format(ax1)
...
ax1.legend(loc='lower left', bbox_to_anchor=(0.8, -0.3), fontsize=20)
