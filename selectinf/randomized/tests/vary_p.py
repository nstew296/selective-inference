...
plt.sca(ax1)
first = plt.boxplot([coverage_by_p[j][2] for j in range(len(p_list))], positions=np.array(range(length)) * 3, sym='', widths=0.3)
second = plt.boxplot([coverage_by_p[j][0] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + .3, sym='', widths=0.3)
third = plt.boxplot([coverage_by_p[j][1] for j in range(len(p_list))], positions=np.array(range(length)) * 3 +.6, sym='', widths=0.3)
fourth = plt.boxplot([coverage_by_p[j][3] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + .9, sym='', widths=0.3)
fifth = plt.boxplot([coverage_by_p[j][4] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.2, sym='', widths=0.3)
sixth = plt.boxplot([coverage_by_p[j][5] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.5, sym='',widths=0.3)
seventh = plt.boxplot([coverage_by_p[j][6] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.8, sym='',widths=0.3)
...
fourth = plt.boxplot([length_by_p[j][3] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + .6, sym='', widths=0.3)
fifth = plt.boxplot([length_by_p[j][4] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 0.9, sym='', widths=0.3)
sixth = plt.boxplot([length_by_p[j][5] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.2, sym='',widths=0.3)
seventh = plt.boxplot([length_by_p[j][6] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.5, sym='',widths=0.3)
...
fourth = plt.boxplot([f1_by_p[j][2] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + .6, sym='', widths=0.3)
fifth = plt.boxplot([f1_by_p[j][3] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 0.9, sym='', widths=0.3)
sixth = plt.boxplot([f1_by_p[j][4] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.2, sym='',widths=0.3)
seventh = plt.boxplot([f1_by_p[j][5] for j in range(len(p_list))], positions=np.array(range(length)) * 3 + 1.5, sym='',widths=0.3)
set_box_color(first, '#2b8cbe','solid')  # colors are from http://colorbrewer2.org/
set_box_color(second, '#6baed6','--')
set_box_color(fourth, '#238443','solid')
set_box_color(fifth, '#31a354','--')
