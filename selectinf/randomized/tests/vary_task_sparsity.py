...
for j in range(len(task_sparsity_list)):
    ...
    for i in range(len(feature_weight_list)):
        print((i,j),"(i,j)")
        sims = test_coverage(feature_weight_list[i],[2.0,5.0],ts=task_sparsity_list[j],nsim=50)
...
plt.sca(ax3)
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][0]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][0])/7.0 for j in range(len(task_sparsity_list))] , c='#2b8cbe')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][1])/7.0 for j in range(len(task_sparsity_list))] , c='#6baed6',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][2]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][2])/7.0 for j in range(len(task_sparsity_list))] , c='#D7191C')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][3])/7.0 for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][4])/7.0 for j in range(len(task_sparsity_list))] , c='#31a354',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][5]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][5])/7.0 for j in range(len(task_sparsity_list))] , c='#fd8d3c')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][6]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][6])/7.0 for j in range(len(task_sparsity_list))] , c='#feb24c',linestyle='--')
...
plt.sca(ax4)
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][0]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][0])/7.0 for j in range(len(task_sparsity_list))] , c='#2b8cbe')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][1])/7.0 for j in range(len(task_sparsity_list))] , c='#6baed6',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][2]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][2])/7.0 for j in range(len(task_sparsity_list))] , c='#D7191C')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][3])/7.0 for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][4])/7.0 for j in range(len(task_sparsity_list))] , c='#31a354',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][5]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][5])/7.0 for j in range(len(task_sparsity_list))] , c='#fd8d3c')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][6]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][6])/7.0 for j in range(len(task_sparsity_list))] , c='#feb24c')
plt.ylim((.98,1.001))
plt.tight_layout()
