...
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][3]) for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][4]) for j in range(len(task_sparsity_list))] , c='#feb24c')
...
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][3]) for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][4]) for j in range(len(task_sparsity_list))] , c='#feb24c')
plt.ylim((.95,1.0))
plt.tight_layout()
...
ax3.legend(loc='lower left', bbox_to_anchor=(-0.1, -0.4),fontsize=14)
