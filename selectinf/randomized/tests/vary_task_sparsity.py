...
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][1])/10.0 for j in range(len(task_sparsity_list))] , c='#6baed6',linestyle='--')
...
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][4])/10.0 for j in range(len(task_sparsity_list))] , c='#31a354',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][5]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][5])/10.0 for j in range(len(task_sparsity_list))] , c='#fd8d3c')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][6]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][6])/10.0 for j in range(len(task_sparsity_list))] , c='#feb24c',linestyle='--')
...
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][1])/10.0 for j in range(len(task_sparsity_list))] , c='#6baed6',linestyle='--')
...
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][4])/10.0 for j in range(len(task_sparsity_list))] , c='#31a354',linestyle='--')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][5]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][5])/10.0 for j in range(len(task_sparsity_list))] , c='#fd8d3c')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][6]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][6])/10.0 for j in range(len(task_sparsity_list))] , c='#feb24c')
plt.ylim((.98,1.001))
plt.tight_layout()
