...
plt.sca(ax3)
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][0]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][0])/4.5 for j in range(len(task_sparsity_list))] , c='#2b8cbe')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][1])/4.5 for j in range(len(task_sparsity_list))] , c='#D7191C')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][2]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][2])/4.5 for j in range(len(task_sparsity_list))] , c='#31a354')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][3])/4.5 for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(sensitivity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(sensitivity_by_ts[j][4])/4.5 for j in range(len(task_sparsity_list))] , c='#feb24c')
...
plt.sca(ax4)
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][0]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][0])/4.5 for j in range(len(task_sparsity_list))] , c='#2b8cbe')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][1]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][1])/4.5 for j in range(len(task_sparsity_list))] , c='#D7191C')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][2]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][2])/4.5 for j in range(len(task_sparsity_list))] , c='#31a354')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][3]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][3])/4.5 for j in range(len(task_sparsity_list))] , c='#238443')
plt.errorbar(task_sparsity_list, [np.mean(specificity_by_ts[j][4]) for j in range(len(task_sparsity_list))], yerr=[np.std(specificity_by_ts[j][4])/4.5 for j in range(len(task_sparsity_list))] , c='#feb24c')
plt.ylim((.95,1.0))
plt.tight_layout()
