...
def main():
    ...
    plt.savefig('lengthcompare_strong_ts40.png', bbox_inches='tight')
    ...
    plt.savefig('coveragecompare_strong_ts40.png', bbox_inches='tight')
    ...
    plt.savefig('specificitycompare_strong_ts40.png')
    ...
    plt.savefig('errcompare_strong_ts40.png',bbox_inches='tight')
